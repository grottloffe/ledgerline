...
```
node "${CLAUDE_PLUGIN_ROOT}/scripts/ledger.js" next-id D
node "${CLAUDE_PLUGIN_ROOT}/scripts/ledger.js" today
```
...
- If it changes scope, it also needs `/ledgerline:roadmap`.
