...
- **Consequences:** Ledger drift is now possible and must be checked (`/superproj:resume`). Every session pays a small update cost in exchange for cheap resumption.
